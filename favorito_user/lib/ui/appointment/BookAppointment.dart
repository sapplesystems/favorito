    ...
    return SafeArea(
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Text(
                         ...
                         Padding(
      padding: EdgeInsets.only(left: sm.w(3),right:sm.w(3),top: sm.h(4)),
      child: Neumorphic(
        ...
        underline: Container(),
        items:vaTrue.servicesList.map<DropdownMenuItem<ServiceModel>>((ServiceModel _va) {
          return DropdownMenuItem<ServiceModel>(
            value: _va,
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: sm.w(2)),
              child: Text(_va.serviceName,style: TextStyle(color: _va.status==0?myGrey:null),)
            )
          );
        })?.toList(),
      ...
      // 
        onChanged: (ServiceModel value) {
          ...
          BotToast.showText(text: 'selected service is not availeble now! Sorry for inconvenience',duration:Duration(seconds: 3) );  
        ...
        Visibility(
          visible: data.selectedServiceId!=0,
                  child: Padding(
      padding: EdgeInsets.only(top: sm.h(3),left:sm.w(3),right:sm.w(3)),
      child: Neumorphic(
          style: NeumorphicStyle(
              shape: NeumorphicShape.convex,
              depth: 8,
          ...
          underline: Container(),
          items: data.personList?.map<DropdownMenuItem<Person>>((Person value) {
          ...
          onChanged: (Person value) {
              data.setSelectedServicePerson(value);
                    ...
                    height: 80,
                      child: ListView(
                        ...
                        children: [
                          for(int _i=0;_i<data.advancebookingDates.length;_i++)Padding(
                            padding: EdgeInsets.symmetric(horizontal: sm.h(1)),
                            child: InkWell(
                              onTap:(){
                                data.selectedDateChange(_i,context,data.advancebookingDates[_i]);
                              },
                                  child: Center(
                                  child: Neumorphic(
                                style: NeumorphicStyle(
                                ...
                                child: Padding(
                                    ...
                                    child: Text(dateFormat8.format(data.advancebookingDates[_i]),
                                        style: TextStyle(
                                            fontSize: sm.h(2),
                                            color: data.selectedDateIndex == _i?myRed:Colors.grey[600]))),
                                  ...
                                  child: Center(
                                    child: Padding(
                                      ...
                                      child: Text(data.slots[_i].startTime,
                                          style: TextStyle(
                                              color: data.selectedTimeIndex==_i
                                                  ? myRed
                                                  : Colors.grey)
                                                  ),
                                    ),
             ...
             decoration: new BoxDecoration(
                ...
                child: Padding(
                    ...
                    child: SvgPicture.asset('assets/icon/delete_white.svg',height: sm.h(4)),
                ),        
          ),
                  ),
          Visibility(
            visible: data.abletoDelete,
              ...
              child: Text('Cancel Booking',textAlign: TextAlign.center,style: TextStyle(color: myRed,fontSize: 16,fontFamily:'Gilroy-Regular' )),
            ),
          )
                  ],
                );

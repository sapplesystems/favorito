              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      for (int i = 0; i < bspTrue.selecteddayList.length; i++)
                        InkWell(
                          onTap: () {
                            bspTrue.setMod(true);
                            if (((bspTrue.selecteddayList.keys.toList())[i])
                                .contains('-')) {
                              print("range is called");
                              int _a = bspTrue.daylist.indexOf(
                                  (((bspTrue.selecteddayList.keys.toList())[i])
                                      .split('-')[0]
                                      .trim()));

                              int _b = bspTrue.daylist.indexOf(
                                  (((bspTrue.selecteddayList.keys.toList())[i])
                                      .split('-')[1]
                                      .trim()));
                              print("$_a ab ");

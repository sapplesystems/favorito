...
router.post('/create-chat-connected', CheckAuth, UserController.createChatConnected);
router.post('/get-chat-connected-list', CheckAuth, UserController.getChatConnectedList);
router.post('/delete-chat-connected-list', CheckAuth, UserController.DeleteChatConnectedList);

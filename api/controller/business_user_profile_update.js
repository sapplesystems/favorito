...
exports.updateProfilePhoto = function(req, res, next) {
    try {
        ...
        db.query(sql, function(err, rows, fields) {
            ...
            return res.status(200).json({ status: 'success', message: 'Business user profile photo updated successfully.', data: [{ photo: img_path + req.file.filename }] });
        });
    } catch (e) {
...
/* 
update profile business before adding code of the alyways open and saving the data in the business_hour
*/
...
exports.updateProfile = async function(req, res, next) {
    try {
        ...
        if (req.body.business_name && req.body.business_phone && req.body.address && req.body.postal_code && req.body.town_city && req.body.state_id && req.body.country_id && req.body.location && req.body.working_hours && req.body.website && req.body.business_email) {
